...
{
    public partial class frm_Resta : Form
    {
        int contadorA = 0;
        int contadorE = 0;
        int resta = 0;
        ...
        public void consultar()
        {
            ...
            while (a == 2)
            {
                ...
                if (int.Parse(tb_num1.Text) > int.Parse(tb_num2.Text))
                {
                    a = 1;
                }
            }

            resta = int.Parse(tb_num1.Text) - int.Parse(tb_num2.Text);
        }
        public void limpiar()
        {
            tb_num1.Text = "";
        ...
        {
            MessageBox.Show("Las reglas son sencillas, acierta correctamente 5 restas y ganas, fallas 3 y pierdes, Buena Suerte!!", "REGLAS DEL JUEGO");
            consultar();
        }
